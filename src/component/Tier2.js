...
import { BsArrowUpShort, BsArrowRight, BsArrowLeft } from "react-icons/bs";
              ...
              <div className="bg-black w-[475px] rounded-t-3xl p-4">
                ...
                <div className="container flex justify-between pt-4">
                  ...
                  <div className="text-[#F0F0F0] text-center">
                    {/* <a href="./Hi/story" className="text-base font-medium underline underline-offset-2" onClick={PoinrHistory()}> View History </a> */}
                    <button
              ...
              <div className="bg-[#F0F0F0] w-[475px] rounded-b-3xl p-[35px]">
                {showNewCoupon ? (
                   ...
                   <div className="flex justify-between pt-[20px]">
                     <span className="text-[#364BFF] text-xl p-3"  onClick={Coupon}>
                     <BsArrowLeft />
                     </span>
                   ...
                   <div className="grid grid-rows-3">
                     <div className="bg-[#FF5352] w-[56px] h-[30px] rounded-tr-xl rounded-bl-xl">
                       <span className="text-white text-center p-2.5">Old</span>
                     </div>
                  ...
                  <div className="grid grid-rows-3">
                    ...
                    <button className="text-[#364BFF] text-lg row-end-3 p-[5px]" onClick={NewCoupon}>
                      <BsArrowRight />
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-white shadow rounded-xl p-3 mt-3">
                  ...
                  {showWayToEarn ? (
                    <div className="bg-gray-100 bg-opacity-70 h-auto p-2.5 mt-2 rounded-lg flex" onClick={WayToEarn}>
                    ...
                    <div className="bg-gray-100 bg-opacity-70 h-12 p-2.5 mt-2 rounded-lg flex" onClick={WayToEarn}>
                    <span className="text-blue-600 p-1">
                      <FaCoins />
                    </span>
                    <label className="text-base font-notmal pl-2">
                  ...
                  {showWatToRedeem ? (
                    <div className="bg-gray-100 bg-opacity-70 h-auto p-2.5 mt-2 rounded-lg flex" onClick={WayToRedeem}>
                    <span className="text-blue-600 p-1">
                      <FaGift />
                    </span>
                    <label className="text-base font-notmal pl-2">
                    ...
                    <div className="bg-gray-100 bg-opacity-70 h-12 p-2.5 mt-2 rounded-lg flex" onClick={WayToRedeem}>
                    <span className="text-blue-600 p-1">
                      <FaGift />
                    </span>
                    <label className="text-base font-notmal pl-2">
