  ...
  return (
     <>
      ...
      <section>
        <nav className='bg-black'>
          <div className='flex justify-center'>
            ...
            <a className='text-lg font-medium text-white p-3' href='#'>Tier 1</a>
            <a className='text-lg font-medium text-white p-3' href='#'> Tier 2</a>
          </div>
        </nav>
      </section>
      ...
      <div className='container'>
          <div className='bg-slate-100 w-[475px] h-auto p-[35px]'>
            <div className='bg-white shadow rounded-xl p-3'>
              ...
              <div className='flex justify-between pt-3'>
              <input type='text' className='w-[267px] h-[45px] border border-slate-100 rounded p-2 placeholder:text-base font-normal opacity-55' placeholder='e.g. 975884823'></input>
              <button type='button' className='bg-blue-600 text-white w-[88px] h-[45px] rounded'>Sign Up</button>
              </div>
